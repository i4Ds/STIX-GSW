function stx_telemetry_packet_structure_solo_source_packet_header, packet_word_width=packet_word_width
  packet_word_width = { $
    ...
    pkg_total_bytes_data_field_header : 10, $ ; Used to keep length of Data Field Header
    source_data                    : -32848L $
