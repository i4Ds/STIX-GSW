...
;
; :description:
;    This takes a science data file and plots a lightcurve binned to given energy and time bins
;
; :categories:
;
;
...
;                    2N or N+1 contiguous energy edges required for lightcurve
;
...
;               Plotman Object containing the binned lightcurve. Supplying this keyord will open a plotman widget showing 
;               the lightcurve plot. 
;
; :returns:
;  
...
pro stx_demo_lightcurve
  ...
  light_curve_str = stx_science_data_lightcurve(fits_path_data_l4, energy_ranges = [4,6,10,28], time_min = time_min,  plot_obj = plot_obj )
  ...
  light_curve_str = stx_science_data_lightcurve(fits_path_data_l4, energy_ranges = [4,6,10,28], time_min = time_min, fits_path_bk =fits_path_bk,  plot_obj = plot_obj  )

  print, "Press SPACE to continue"
  print, " "
  pause

  light_curve_str = stx_science_data_lightcurve(fits_path_data_l1, /is_pixel_data, energy_ranges = [4,6,10,28], time_min = time_min,  plot_obj = plot_obj)

  print, "Press SPACE to continue"
  print, " "
  pause

  light_curve_str = stx_science_data_lightcurve(fits_path_data_l1, /is_pixel_data, energy_ranges = [4,6,10,28], time_min = time_min ,  fits_path_bk = fits_path_bk,  plot_obj = plot_obj )
