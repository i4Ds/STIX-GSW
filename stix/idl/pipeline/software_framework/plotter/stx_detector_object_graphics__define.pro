;+
; :file_comments:
;      Creating a graphics object to represent a detector.
...
;-
function stx_detector_object_graphics::init, _extra=extra
  ...
  ; Create the graphic objects for the 4 small pixels
  ...
  ; Add the small pixels and the lines of the small pixels to self
  ...
  ; Create the graphic objects for the 4 big pixels in the bottom row
...
;    17-Dec-2015 - Roman Boutellier (FHNW), Initial release
;-
function stx_detector_object_graphics::_overloadPrint
...
;    17-Dec-2015 - Roman Boutellier (FHNW), Initial release
;-
pro stx_detector_object_graphics::_update_border
...
;    17-Dec-2015 - Roman Boutellier (FHNW), Initial release
;-
pro stx_detector_object_graphics::_update_plot
   compile_opt idl2, hidden
...
;    17-Dec-2015 - Roman Boutellier (FHNW), Initial release
;-
pro stx_detector_object_graphics::_update_data
   compile_opt idl2, hidden
...
;    17-Dec-2015 - Roman Boutellier (FHNW), Initial release
;-
pro stx_detector_object_graphics::_getPlotData, data, x=x, y=y
  compile_opt idl2, hidden
...
;    17-Dec-2015 - Roman Boutellier (FHNW), Initial release
;-
function stx_detector_object_graphics::_getColor, _value
  compile_opt idl2, hidden
  
  value = _value
  value[8:11] *= self.smallpixelboost
...
pro stx_detector_object_graphics::cleanup
...
;    17-Dec-2015 - Roman Boutellier (FHNW), Initial release
;-
pro stx_detector_object_graphics::SetProperty, _EXTRA=ex, $
...
pro stx_detector_object_graphics__define
  compile_opt idl2
  
  define = {stx_detector_object_graphics, $
             bordercolor : 255, $
             borderthick : 2, $
             linecolor : 255, $
             linethick : 2, $
