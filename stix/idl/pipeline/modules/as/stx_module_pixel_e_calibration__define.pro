;---------------------------------------------------------------------------
; Document name: stx_module_pixel_e_calibration__define.pro
; Created by:    nicky.hochmuth 02.05.2013
;---------------------------------------------------------------------------
;+
; PROJECT:          STIX
;
; NAME:             stx_module_pixel_e_calibration Object
;
; PURPOSE:          Wrapping the pixel energy calibration for the pipeline
;
; CATEGORY:         STIX PIPELINE
;
; CALLING SEQUENCE: modul = stx_module_pixel_e_calibration()
...
function stx_module_pixel_e_calibration::init, module, input_type
...
function stx_module_pixel_e_calibration::_execute, in, configuration
  compile_opt hidden
...
;-
function stx_module_pixel_e_calibration::_verify_input, in
  compile_opt hidden
...
;-
function stx_module_pixel_e_calibration::_verify_configuration, configuration
  compile_opt hidden
...
;-
pro stx_module_pixel_e_calibration::cleanup
...
; :hidden:
;-
pro stx_module_pixel_e_calibration__define
  compile_opt idl2, hidden
  
  void = { stx_module_pixel_e_calibration, $
           inherits ppl_module }
end
