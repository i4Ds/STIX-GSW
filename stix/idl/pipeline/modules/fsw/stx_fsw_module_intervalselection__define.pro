...
;
; :examples:
;    obj = new_obj('stx_fsw_module_intervalselection')
;
; :history:
...
pro stx_fsw_module_intervalselection::update_io_data, conf
...
;-
function stx_fsw_module_intervalselection::_execute, in, configuration
  compile_opt hidden
  ...
  return, stx_fsw_ivs(in.archive_buffer,  in.start_time, in.rcr, in.rcr_time_axis, $
...
; :hidden:
;-
pro stx_fsw_module_intervalselection__define
  compile_opt idl2, hidden
  
  void = { stx_fsw_module_intervalselection, inherits ppl_module_lut }
end
