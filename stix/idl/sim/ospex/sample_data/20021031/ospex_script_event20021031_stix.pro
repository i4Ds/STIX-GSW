; OSPEX script created Mon Apr 29 00:42:04 2013 by OSPEX writescript method.                
;                                                                                           
...
;  For example:                                                                             
;     ospex_script_event20021031_stix, obj=obj                                              
;                                                                                           
...
obj-> set, fit_comp_params= [0.816270, 1.61524, 1.00000, 0.000799238, 8.46922, 400.000, $   
 1.93000]                                                                                   
...
obj-> set, spex_eband= [[4.00000, 12.0000], [12.0000, 25.7280], [25.7280, 48.2910], $       
 [48.2910, 102.806], [102.806, 150.000]]                 
 restorefit = loc_file('ospex_results_20021031_stix.fits', path=[getenv('IDL_WORKSPACE_PATH'), getenv('SSW')+'/so']+'/stix/idl/sim/ospex/sample_data/20021031')
