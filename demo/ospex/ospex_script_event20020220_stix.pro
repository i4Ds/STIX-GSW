...
;                                                                                           
pro ospex_script_event20020220_stix, obj=obj                                                
...
obj-> set, spex_eband= [[4.00000, 12.0000], [12.0000, 25.7280], [25.7280, 48.2910], $       
 [48.2910, 102.806], [102.806, 150.000]]                                
restorefit = loc_file('ospex_results_20020220_stix.fits', path=[getenv('IDL_WORKSPACE_PATH'), getenv('SSW')+'/so']+'/stix/idl/sim/ospex/sample_data/20020220')
