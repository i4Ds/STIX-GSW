; OSPEX script created Tue Apr  2 16:12:05 2013 by OSPEX writescript method.                
;                                                                                           
...
;  For example:                                                                             
;     ospex_script_event20020220_stix, obj=obj                                              
;                                                                                           
...
;                                                                                           
pro ospex_script_event20020220_stix_nogui, obj=obj                                                
if not is_class(obj,'SPEX',/quiet) then obj = ospex(/nogui)                                       
obj-> set, spex_fit_firstint_method= 's6'                                                   
obj-> set, spex_erange= [6.0000000D, 102.80600D]                                            
...
obj-> set, fit_comp_params= [1.47263e-16, 7.59030, 1.00000, 1.22006e-06, 9.87398, 51.1200, $
 4.03700]                                                                                   
...
obj-> set, spex_eband= [[4.00000, 12.0000], [12.0000, 25.7280], [25.7280, 48.2910], $       
 [48.2910, 102.806], [102.806, 150.000]]
restorefit = loc_file('ospex_results_20020220_stix_nogui.fits', path=[getenv('IDL_WORKSPACE_PATH'), getenv('SSW')+'/so']+'/stix/idl/sim/ospex/sample_data/20020220')
